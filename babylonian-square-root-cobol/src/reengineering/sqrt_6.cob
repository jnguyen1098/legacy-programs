...
*> - removed 1000 abort timeout. It is useless. Now the program will
*>   just loop 1000 times.
*>   
*>   I will probably remove epsilon input next iteration and hard-
*>   code it in, as that is an implementation detail that the user
*>   doesn't need.
*>   
*>   I am still debating whether or not to add a time-out to the new
*>   program - I don't think there is a noticeable case where there
*>   would be problems finding the square root within a reasonable
*>   epsilon. 
...
01 lineStruct.
    ...
    02 filler pic x(58). *> reads in 58 spaces
...
GET_NEW_LINE.
    ...
    if radicandIn is less than or equal to zero
